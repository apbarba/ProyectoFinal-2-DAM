package com.salesianostriana.dam.imagineria_web.error.controller;
...
@RestController
@RequestMapping(ObrasErrorController.ERROR_PATH)
public class ObrasErrorController extends AbstractErrorController {
    ...
    public ObrasErrorController(ErrorAttributes errorAttributes)  {

...
@Log
@AllArgsConstructor
public class FavoritosSpecification implements Specification<Favoritos> {

    private SearchCriteria searchCriteria;

    @Override
    public Predicate toPredicate(Root<Favoritos> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {

...
@Log
@AllArgsConstructor
public class ObrasSpecification implements Specification<Obras> {

    private SearchCriteria searchCriteria;

    @Override
    public Predicate toPredicate(Root<Obras> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
